...
export class InitDatabase {
  ...
  createDatabase() {
    ...
    this._db.transaction(function (tx) {
      ...
      tx.executeSql('CREATE TABLE IF NOT EXISTS profile (id INTEGER PRIMARY KEY, firstname TEXT, lastname TEXT, email TEXT, password TEXT, birthday DATE, notification BOOLEAN, timestamp DATETIME DEFAULT CURRENT_TIMESTAMP, patient BOOLEAN, caregiver BOOLEAN, publicprofile BOOLEAN, mystory TEXT, myupdates TEXT, picture TEXT)');      
    });
  }
  dropDatabase() {
